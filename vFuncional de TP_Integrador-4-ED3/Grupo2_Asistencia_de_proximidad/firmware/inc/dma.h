 ...
 * @details  Deshabilita el canal, recarga los registros del canal (SrcAddr,
 *           DstAddr, LLI, Control) desde la LLI y lo reactiva. Llamar luego de
 *           actualizar el buffer de la señal para evitar mezclar muestras viejas
 *           y nuevas en un mismo ciclo DMA.
 * @note     USW.2.1.14.1
 **********************************************************************************/

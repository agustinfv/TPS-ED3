 ...
 * @details  Detiene el canal, recarga los registros del canal desde dacLLI y
 *           lo reactiva. Debe llamarse luego de actualizar el buffer de la señal
 *           para garantizar que el DMA arranque desde el inicio del nuevo LUT
 *           sin mezclar muestras viejas y nuevas.
 * @note     USW.2.1.14.1
 **********************************************************************************/
void DMA_Reload(void)
{
	if(!dmaReady) return;

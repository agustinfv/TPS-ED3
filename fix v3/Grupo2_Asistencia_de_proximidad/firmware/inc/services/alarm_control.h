...
/*******************************************************************************//**
 * @brief    Inicializa el servicio de control de alarma y el hardware.
 ...
 **********************************************************************************/
void AC_SetMode(buzzer_id id, buzzer_mode mode);
 ...
 **********************************************************************************/
void AC_SetVolume(buzzer_id id, uint8_t volume);
 ...
 **********************************************************************************/
void AC_SetThreshold(buzzer_id id, uint32_t threshold);
 ...
 **********************************************************************************/
void AC_SetLED(sensor_id id, led_color color);
